                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                        ...
                                        <img align="center" alt="" src="https://gallery.mailchimp.com/f2ce15151dcb19fcd081edcb1/images/7c983648-0ed1-409a-b15a-51cb6cea898f.png" width="150" style="max-width: 150px;padding-bottom: 0px;vertical-align: bottom;display: inline !important;border: 1px groove #F7EAEA;border-radius: 50%;" class="mcnImage">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px; text-align: center;">
                            ...
                            <h1 style="text-align: center;">Заказ № {{$id}}.</h1>
...
<table class="tg" style="text-align: center; width: 100%;margin: 0 auto;">
	<tbody>
		...
		<tr>
			...
			<td class="tg-ynlj">{{$short_description}}</td>
		</tr>
	</tbody>
</table>
</div>
