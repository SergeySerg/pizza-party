        ...
        <div class="mdl-grid">
            ...
            <div class="mdl-cell mdl-cell--3-col tac item">
                <div class="item_popup" 
                    data-info='[{"id":"{{ $pizza->id}}","size":"32","weigth":"{{ $pizza->getAttributeTranslate("weight_32")}}","category":"{{ $type }}","liters":null,"persons":null,"price":"{{ $pizza->getAttributeTranslate("price_32")}}"},{"id":"{{ $pizza->id}}","size":"40","weigth":"{{ $pizza->getAttributeTranslate("weight_40")}}","category":"{{ $type }}","liters":null,"persons":null,"price":"{{ $pizza->getAttributeTranslate("price_40")}}"}]'
